...
WORKFLOWS_SERVICE_ACCOUNT = os.environ.get("WORKFLOWS_SERVICE_ACCOUNT")
WORKFLOWS_SERVICE_PASSWORD = os.environ.get("WORKFLOWS_SERVICE_PASSWORD")

# TODO Get this from the env
# WORKFLOW_EXECUTOR_ACCESS_TOKEN = os.environ.get("WORKFLOWS_EXECUTOR_ACCESS_TOKEN"]
...
TAPIS_DEV_URL = os.environ.get("TAPIS_DEV_URL")
TAPIS_DEV_TENANT = "dev" # TODO add to environment variables
LOCAL_DEV_HOSTS = ["127.0.0.1", "localhost", "c006.rodeo.tacc.utexas.edu"]

TAPIS_SERVICE_SITE_ID = os.environ.get("TAPIS_SERVICE_SITE_ID")
TAPIS_SERVICE_TENANT_ID = os.environ.get("TAPIS_SERVICE_TENANT_ID")
TAPIS_SERVICE_ACCOUNT = WORKFLOWS_SERVICE_ACCOUNT
TAPIS_SERVICE_ACCOUNT_PASSWORD = WORKFLOWS_SERVICE_PASSWORD
WORKFLOWS_SERVICE_URL = os.environ.get("WORKFLOWS_SERVICE_URL")
