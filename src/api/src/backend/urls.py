...
from backend.views.AddArchive import AddArchive
from backend.views.RemoveArchive import RemoveArchive
...
urlpatterns = [
    ...
    path("pipelines/<str:group_id>/<str:pipeline_id>/archives/add", AddArchive.as_view()),
    path("pipelines/<str:group_id>/<str:pipeline_id>/archives/remove", RemoveArchive.as_view()),
