...
urlpatterns = [
    ...
    path("pipelines/<str:group_id>/<str:pipeline_id>/addArchive", AddArchive.as_view()),
    path("pipelines/<str:group_id>/<str:pipeline_id>/removeArchive", RemoveArchive.as_view()),
